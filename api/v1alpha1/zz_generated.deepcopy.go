...
func (in *LakekeeperExternalDB) DeepCopy() *LakekeeperExternalDB {
	if in == nil {
		return nil
	}
	out := new(LakekeeperExternalDB)
	in.DeepCopyInto(out)
	return out
}
