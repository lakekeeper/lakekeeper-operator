...
*/}}
{{- define "lakekeeper-operator.name" -}}
...
*/}}
{{- define "lakekeeper-operator.fullname" -}}
...
*/}}
{{- define "lakekeeper-operator.resourceName" -}}
{{- $fullname := include "lakekeeper-operator.fullname" .context }}
{{- $suffix := .suffix }}
