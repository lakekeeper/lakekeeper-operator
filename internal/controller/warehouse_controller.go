...
//+kubebuilder:rbac:groups=cache.lakekeeper.io,resources=warehouses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.lakekeeper.io,resources=warehouses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.lakekeeper.io,resources=warehouses/finalizers,verbs=update
